...
# 27 "mcc_generated_files/drivers/../spi1_types.h"
typedef enum {
SPI1_DEFAULT,
MASTER_CONFIG
} spi1_modes;

# 35 "mcc_generated_files/drivers/../spi1_driver.h"
...
{ spi1_close, MASTER_open, spi1_exchangeByte, spi1_exchangeBlock, spi1_writeBlock, spi1_readBlock, spi1_writeByte, spi1_readByte, spi1_setSpiISR, spi1_isr }
};

inline bool MASTER_open(void){
return spi1_open(MASTER_CONFIG);
}
