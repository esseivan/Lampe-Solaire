...
# 63 "mcc_generated_files/tmr4.h"
unsigned char TMR4_INT_FLAG = 0;

# 68
unsigned char TMR4_INTERRUPT_TICKER_FACTOR = 2;
...
int code = PORTAbits.RA1 + 2*PORTAbits.RA6 + 4*PORTAbits.RA7 + 8*PORTAbits.RA0;
if(code & A) {
POWER_LED_ON();
} else if(code & B) {
POWER_LED_OFF();
